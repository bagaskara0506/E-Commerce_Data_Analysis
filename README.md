...
> Proyek ini bertujuan untuk menganalisa kumpulan Data Pesanan Olist Store yang berisi data informasi 100.000 pesanan dari tahun 2016 sampai 2018 yang diproses dari berbagai marketplace Brasil. Proyek ini berfokus pada ekstraksi data menggunakan PostgreSQL, Lalu memproses Analisa dan visualisasi Business Performance & RFM Analysis dengan Python, Untuk visualisasi tambahan dashboard interactive menggunakan Looker Studio

**[KLIK DI SINI UNTUK MELIHAT INTERACTIVE DASHBOARD LOOKER STUDIO](https://lookerstudio.google.com/reporting/1a808948-4b81-45cb-a9c1-5cd7950ee41b)**
...
2. **Customer Retention (RFM) :** Bagaimana karakteristik pelanggan dan mengetahui kemampuan bisnis dalam mempertahankan pelanggan untuk membeli, meningkatkan intensitas kunjungan dan spending (_Recency, Frequency, Monetary_) ?
...
> Folder File : E-Commerce_Data_Analysis/notebooks
...
- **Krisis Retensi Pelanggan :** Mayoritas pelanggan memiliki intensitas kunjungan hanya sekali dengan total presentase `97%`.
